            ...
            if (data.code == 100) {
                ...
                $(list).each(function (index, data) {
                    var TeacherInfo = '<li class="cf2"><div class="teacher_head"><a href="teacher_info.html" target="_blank" title="家教">'
                        ...
                        + '<span class="honor_label"><i class="' + (data.sex == 0 ? "female" : "male") + '"></i><span><i class="good" title="未签约"></i></span><span class="' + (data.isverify == 2 ? "on" : "") + '"><i class="v" title="' + (data.isverify == 2 ? "已审核证件" : "未审核证件") + '"></i></span></span> <em>' + data.currentStatus + '</em></div>'
